...
def build_manual(filename: str, title: str, subtitle: str, audience: str, sections: Sequence[SectionSpec], callout: str, version_line: str = "Version 1.8 | Sprint 18D | July 2026", page_break_after_contents: bool = False, contents_space_after: float = 4) -> Path:
    doc = Document()
...
def main() -> None:
    ...
    if portfolio_only:
        build_manual(
            ...
            "Version 1.8 | Sprint 18D | July 2026",
            True,
            2,
        )
        return
    ...
    build_manual(
        ...
        onboarding_sections(),
        "Read sequentially during onboarding, then return to the subsystem playbooks while debugging. Commands and paths are verified against the repository through Sprint 18D.",
    )
    build_manual(
